...
require 'paperclip/form_helpers'
require 'paperclip/policy_helper'
require 'paperclip/paperclip_manager'

ActionView::Helpers::FormHelper.send(:include, Paperclip::FormHelper)
ActionView::Base.send(:include, Paperclip::FormHelper)
